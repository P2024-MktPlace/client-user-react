  ...
  useEffect(() => {
    const handleLoad = () => {
      ...
      const extractedParams = {
        ...
        razorpay_payment_link_reference_id: queryParams.get(
          'razorpay_payment_link_reference_id'
        ),
        razorpay_payment_link_status: queryParams.get(
      ...
      <Card sx={{ borderRadius: 3, padding: 4, boxShadow: 3 }}>
        <CardContent>
          ...
          <Typography variant="body1" sx={{ marginBottom: 4 }}>
            ...
            confirmation email shortly. If you have any questions, feel free to
          ...
          <Typography
            variant="body1"
            sx={{ marginBottom: 4, fontStyle: 'italic', color: 'orange' }}
          >
